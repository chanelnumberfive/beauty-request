(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["BeautyRequest"] = factory();
	else
		root["BeautyRequest"] = factory();
})(window, function() {
...
function BeautyRequest(_config) {
  ...
  this.CancelToken = axios__WEBPACK_IMPORTED_MODULE_0___default.a.CancelToken;
...
BeautyRequest.prototype.beautyRequest = function (obj, vm, method, ajaxId) {
  ...
  if(obj.progress) nprogress__WEBPACK_IMPORTED_MODULE_1___default.a.start();
  return new Promise((resolve, reject) => {
    this.axiosInstance[method](obj.url, obj.params, ajaxId).then((res) => {
      ...
      if(obj.progress) nprogress__WEBPACK_IMPORTED_MODULE_1___default.a.done();
    });
  });
};
...
BeautyRequest.prototype.init = function (token, host, tokenKey) {
  ...
  // 创建axios实例
  this.axiosInstance = axios__WEBPACK_IMPORTED_MODULE_0___default.a.create(this.ajax || {
    timeout: 30000,
    headers: {
      post: {
...
/* harmony default export */ __webpack_exports__["default"] = (BeautyRequest);
...
//# sourceMappingURL=beauty-request.map